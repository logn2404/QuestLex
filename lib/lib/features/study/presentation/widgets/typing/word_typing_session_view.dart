...
class _WordTypingSessionViewState extends State<WordTypingSessionView> {
  ...
  String get _definition =>
      (widget.words[_currentIndex]['definition'] ?? 'Chưa có định nghĩa').toString();
  ...
  void _handleSubmit() {
    ...
    int finalQuality = isRight ? _currentQuality : 1;
                ...
                child: Column(
                  children: [
                    ...
                    TypingInputSection(
                      ...
                      remainingWords: widget.words.length - _currentIndex,
